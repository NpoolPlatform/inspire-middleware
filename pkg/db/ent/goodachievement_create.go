...
func (gac *GoodAchievementCreate) Save(ctx context.Context) (*GoodAchievement, error) {
	...
	if len(gac.hooks) == 0 {
		...
		nv, ok := v.(*GoodAchievement)
		if !ok {
			return nil, fmt.Errorf("unexpected node type %T returned from GoodAchievementMutation", v)
		}
		node = nv
	}
	return node, err
...
func (gac *GoodAchievementCreate) defaults() error {
	if _, ok := gac.mutation.CreatedAt(); !ok {
		if goodachievement.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized goodachievement.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := goodachievement.DefaultCreatedAt()
		gac.mutation.SetCreatedAt(v)
	}
	if _, ok := gac.mutation.UpdatedAt(); !ok {
		if goodachievement.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized goodachievement.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := goodachievement.DefaultUpdatedAt()
		gac.mutation.SetUpdatedAt(v)
	}
	if _, ok := gac.mutation.DeletedAt(); !ok {
		if goodachievement.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized goodachievement.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := goodachievement.DefaultDeletedAt()
		gac.mutation.SetDeletedAt(v)
	}
	if _, ok := gac.mutation.EntID(); !ok {
		if goodachievement.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized goodachievement.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := goodachievement.DefaultEntID()
		gac.mutation.SetEntID(v)
	}
	if _, ok := gac.mutation.AppID(); !ok {
		if goodachievement.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized goodachievement.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := goodachievement.DefaultAppID()
		gac.mutation.SetAppID(v)
	}
	if _, ok := gac.mutation.UserID(); !ok {
		if goodachievement.DefaultUserID == nil {
			return fmt.Errorf("ent: uninitialized goodachievement.DefaultUserID (forgotten import ent/runtime?)")
		}
		v := goodachievement.DefaultUserID()
		gac.mutation.SetUserID(v)
	}
	if _, ok := gac.mutation.GoodID(); !ok {
		if goodachievement.DefaultGoodID == nil {
			return fmt.Errorf("ent: uninitialized goodachievement.DefaultGoodID (forgotten import ent/runtime?)")
		}
		v := goodachievement.DefaultGoodID()
		gac.mutation.SetGoodID(v)
	}
	if _, ok := gac.mutation.AppGoodID(); !ok {
		if goodachievement.DefaultAppGoodID == nil {
			return fmt.Errorf("ent: uninitialized goodachievement.DefaultAppGoodID (forgotten import ent/runtime?)")
		}
...
func (gac *GoodAchievementCreate) check() error {
	if _, ok := gac.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "GoodAchievement.created_at"`)}
	}
	if _, ok := gac.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "GoodAchievement.updated_at"`)}
	}
	if _, ok := gac.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "GoodAchievement.deleted_at"`)}
	}
	if _, ok := gac.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "GoodAchievement.ent_id"`)}
	}
	return nil
}
...
func (gac *GoodAchievementCreate) createSpec() (*GoodAchievement, *sqlgraph.CreateSpec) {
	...
	if value, ok := gac.mutation.CreatedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: goodachievement.FieldCreatedAt,
		})
	...
	if value, ok := gac.mutation.UpdatedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: goodachievement.FieldUpdatedAt,
		})
	...
	if value, ok := gac.mutation.DeletedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: goodachievement.FieldDeletedAt,
		})
	...
	if value, ok := gac.mutation.EntID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: goodachievement.FieldEntID,
		})
		_node.EntID = value
	}
	if value, ok := gac.mutation.AppID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: goodachievement.FieldAppID,
		})
		_node.AppID = value
	}
	if value, ok := gac.mutation.UserID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: goodachievement.FieldUserID,
		})
		_node.UserID = value
	}
	if value, ok := gac.mutation.GoodID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: goodachievement.FieldGoodID,
		})
		_node.GoodID = value
	}
	if value, ok := gac.mutation.AppGoodID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: goodachievement.FieldAppGoodID,
		})
	...
	if value, ok := gac.mutation.TotalUnits(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			...
			Value:  value,
			Column: goodachievement.FieldTotalUnits,
		})
	...
	if value, ok := gac.mutation.SelfUnits(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeOther,
			Value:  value,
			Column: goodachievement.FieldSelfUnits,
		})
	...
	if value, ok := gac.mutation.TotalAmountUsd(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeOther,
			Value:  value,
			Column: goodachievement.FieldTotalAmountUsd,
		})
	...
	if value, ok := gac.mutation.SelfAmountUsd(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeOther,
			Value:  value,
			Column: goodachievement.FieldSelfAmountUsd,
		})
	...
	if value, ok := gac.mutation.TotalCommissionUsd(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeOther,
			Value:  value,
			Column: goodachievement.FieldTotalCommissionUsd,
		})
	...
	if value, ok := gac.mutation.SelfCommissionUsd(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeOther,
			Value:  value,
			Column: goodachievement.FieldSelfCommissionUsd,
		})
...
func (u *GoodAchievementUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for GoodAchievementCreate.OnConflict")
	}
...
func (u *GoodAchievementUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the GoodAchievementCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for GoodAchievementCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
