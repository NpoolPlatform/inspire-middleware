...
func (cq *CommissionQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (cq *CommissionQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (cq *CommissionQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (cq *CommissionQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (cq *CommissionQuery) IDs(ctx context.Context) ([]uuid.UUID, error) {
	var ids []uuid.UUID
...
func (cq *CommissionQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
