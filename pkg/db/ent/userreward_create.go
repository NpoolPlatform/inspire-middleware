...
func (urc *UserRewardCreate) defaults() error {
	if _, ok := urc.mutation.CreatedAt(); !ok {
		if userreward.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized userreward.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := userreward.DefaultCreatedAt()
		urc.mutation.SetCreatedAt(v)
	}
	if _, ok := urc.mutation.UpdatedAt(); !ok {
		if userreward.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized userreward.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := userreward.DefaultUpdatedAt()
		urc.mutation.SetUpdatedAt(v)
	}
	if _, ok := urc.mutation.DeletedAt(); !ok {
		if userreward.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized userreward.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := userreward.DefaultDeletedAt()
		urc.mutation.SetDeletedAt(v)
	}
	if _, ok := urc.mutation.EntID(); !ok {
		if userreward.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized userreward.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := userreward.DefaultEntID()
		urc.mutation.SetEntID(v)
	}
	if _, ok := urc.mutation.AppID(); !ok {
		if userreward.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized userreward.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := userreward.DefaultAppID()
		urc.mutation.SetAppID(v)
	}
	if _, ok := urc.mutation.UserID(); !ok {
		if userreward.DefaultUserID == nil {
			return fmt.Errorf("ent: uninitialized userreward.DefaultUserID (forgotten import ent/runtime?)")
		}
...
func (urc *UserRewardCreate) check() error {
	if _, ok := urc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "UserReward.created_at"`)}
	}
	if _, ok := urc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "UserReward.updated_at"`)}
	}
	if _, ok := urc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "UserReward.deleted_at"`)}
	}
	if _, ok := urc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "UserReward.ent_id"`)}
	}
	return nil
}
...
func (u *UserRewardUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for UserRewardCreate.OnConflict")
	}
...
func (u *UserRewardUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the UserRewardCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for UserRewardCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
