...
const (
	// Label holds the string label denoting the goodcoinachievement type in the database.
	Label = "good_coin_achievement"
	...
	// Table holds the table name of the goodcoinachievement in the database.
	Table = "good_coin_achievements"
)

// Columns holds all SQL columns for goodcoinachievement fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
