...
func (ecc *EventCoinCreate) Save(ctx context.Context) (*EventCoin, error) {
	...
	if len(ecc.hooks) == 0 {
		...
		nv, ok := v.(*EventCoin)
		if !ok {
			return nil, fmt.Errorf("unexpected node type %T returned from EventCoinMutation", v)
		}
		node = nv
	}
	return node, err
...
func (ecc *EventCoinCreate) defaults() error {
	if _, ok := ecc.mutation.CreatedAt(); !ok {
		if eventcoin.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized eventcoin.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := eventcoin.DefaultCreatedAt()
		ecc.mutation.SetCreatedAt(v)
	}
	if _, ok := ecc.mutation.UpdatedAt(); !ok {
		if eventcoin.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized eventcoin.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := eventcoin.DefaultUpdatedAt()
		ecc.mutation.SetUpdatedAt(v)
	}
	if _, ok := ecc.mutation.DeletedAt(); !ok {
		if eventcoin.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized eventcoin.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := eventcoin.DefaultDeletedAt()
		ecc.mutation.SetDeletedAt(v)
	}
	if _, ok := ecc.mutation.EntID(); !ok {
		if eventcoin.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized eventcoin.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := eventcoin.DefaultEntID()
		ecc.mutation.SetEntID(v)
	}
	if _, ok := ecc.mutation.AppID(); !ok {
		if eventcoin.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized eventcoin.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := eventcoin.DefaultAppID()
		ecc.mutation.SetAppID(v)
	}
	if _, ok := ecc.mutation.EventID(); !ok {
		if eventcoin.DefaultEventID == nil {
			return fmt.Errorf("ent: uninitialized eventcoin.DefaultEventID (forgotten import ent/runtime?)")
		}
		v := eventcoin.DefaultEventID()
		ecc.mutation.SetEventID(v)
	}
	if _, ok := ecc.mutation.CoinConfigID(); !ok {
		if eventcoin.DefaultCoinConfigID == nil {
			return fmt.Errorf("ent: uninitialized eventcoin.DefaultCoinConfigID (forgotten import ent/runtime?)")
		}
...
func (ecc *EventCoinCreate) check() error {
	if _, ok := ecc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "EventCoin.created_at"`)}
	}
	if _, ok := ecc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "EventCoin.updated_at"`)}
	}
	if _, ok := ecc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "EventCoin.deleted_at"`)}
	}
	if _, ok := ecc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "EventCoin.ent_id"`)}
	}
	return nil
}
...
func (ecc *EventCoinCreate) createSpec() (*EventCoin, *sqlgraph.CreateSpec) {
	...
	if value, ok := ecc.mutation.CreatedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: eventcoin.FieldCreatedAt,
		})
	...
	if value, ok := ecc.mutation.UpdatedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: eventcoin.FieldUpdatedAt,
		})
	...
	if value, ok := ecc.mutation.DeletedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: eventcoin.FieldDeletedAt,
		})
	...
	if value, ok := ecc.mutation.CoinConfigID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: eventcoin.FieldCoinConfigID,
		})
...
func (u *EventCoinUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for EventCoinCreate.OnConflict")
	}
...
func (u *EventCoinUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the EventCoinCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for EventCoinCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
