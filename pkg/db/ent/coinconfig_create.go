...
func (ccc *CoinConfigCreate) defaults() error {
	if _, ok := ccc.mutation.CreatedAt(); !ok {
		if coinconfig.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized coinconfig.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := coinconfig.DefaultCreatedAt()
		ccc.mutation.SetCreatedAt(v)
	}
	if _, ok := ccc.mutation.UpdatedAt(); !ok {
		if coinconfig.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized coinconfig.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := coinconfig.DefaultUpdatedAt()
		ccc.mutation.SetUpdatedAt(v)
	}
	if _, ok := ccc.mutation.DeletedAt(); !ok {
		if coinconfig.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized coinconfig.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := coinconfig.DefaultDeletedAt()
		ccc.mutation.SetDeletedAt(v)
	}
	if _, ok := ccc.mutation.EntID(); !ok {
		if coinconfig.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized coinconfig.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := coinconfig.DefaultEntID()
		ccc.mutation.SetEntID(v)
	}
	if _, ok := ccc.mutation.AppID(); !ok {
		if coinconfig.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized coinconfig.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := coinconfig.DefaultAppID()
		ccc.mutation.SetAppID(v)
	}
	if _, ok := ccc.mutation.CoinTypeID(); !ok {
		if coinconfig.DefaultCoinTypeID == nil {
			return fmt.Errorf("ent: uninitialized coinconfig.DefaultCoinTypeID (forgotten import ent/runtime?)")
		}
...
func (ccc *CoinConfigCreate) check() error {
	if _, ok := ccc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "CoinConfig.created_at"`)}
	}
	if _, ok := ccc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "CoinConfig.updated_at"`)}
	}
	if _, ok := ccc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "CoinConfig.deleted_at"`)}
	}
	if _, ok := ccc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "CoinConfig.ent_id"`)}
	}
	return nil
}
...
func (u *CoinConfigUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for CoinConfigCreate.OnConflict")
	}
...
func (u *CoinConfigUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the CoinConfigCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for CoinConfigCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
