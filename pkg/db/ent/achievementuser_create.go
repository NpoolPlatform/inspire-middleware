...
func (auc *AchievementUserCreate) defaults() error {
	if _, ok := auc.mutation.CreatedAt(); !ok {
		if achievementuser.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized achievementuser.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := achievementuser.DefaultCreatedAt()
		auc.mutation.SetCreatedAt(v)
	}
	if _, ok := auc.mutation.UpdatedAt(); !ok {
		if achievementuser.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized achievementuser.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := achievementuser.DefaultUpdatedAt()
		auc.mutation.SetUpdatedAt(v)
	}
	if _, ok := auc.mutation.DeletedAt(); !ok {
		if achievementuser.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized achievementuser.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := achievementuser.DefaultDeletedAt()
		auc.mutation.SetDeletedAt(v)
	}
	if _, ok := auc.mutation.EntID(); !ok {
		if achievementuser.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized achievementuser.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := achievementuser.DefaultEntID()
		auc.mutation.SetEntID(v)
	}
	if _, ok := auc.mutation.AppID(); !ok {
		if achievementuser.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized achievementuser.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := achievementuser.DefaultAppID()
		auc.mutation.SetAppID(v)
	}
	if _, ok := auc.mutation.UserID(); !ok {
		if achievementuser.DefaultUserID == nil {
			return fmt.Errorf("ent: uninitialized achievementuser.DefaultUserID (forgotten import ent/runtime?)")
		}
...
func (auc *AchievementUserCreate) check() error {
	if _, ok := auc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "AchievementUser.created_at"`)}
	}
	if _, ok := auc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "AchievementUser.updated_at"`)}
	}
	if _, ok := auc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "AchievementUser.deleted_at"`)}
	}
	if _, ok := auc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "AchievementUser.ent_id"`)}
	}
	return nil
}
...
func (u *AchievementUserUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AchievementUserCreate.OnConflict")
	}
...
func (u *AchievementUserUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the AchievementUserCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AchievementUserCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
