...
const (
	// Label holds the string label denoting the achivement type in the database.
	Label = "achivement"
	...
	// Table holds the table name of the achivement in the database.
	Table = "archivement_generals"
)

// Columns holds all SQL columns for achivement fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
