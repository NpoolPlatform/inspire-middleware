...
func (aq *AchievementQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (aq *AchievementQuery) FirstIDX(ctx context.Context) uint32 {
...
func (aq *AchievementQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (aq *AchievementQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (aq *AchievementQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (aq *AchievementQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(achievement.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
...
//
//	client.Achievement.Query().
//		Select(achievement.FieldCreatedAt).
//		Scan(ctx, &v)
//
...
func (aq *AchievementQuery) prepareQuery(ctx context.Context) error {
	...
	if achievement.Policy == nil {
		return errors.New("ent: uninitialized achievement.Policy (forgotten import ent/runtime?)")
	}
	if err := achievement.Policy.EvalQuery(ctx, aq); err != nil {
		return err
	}
	return nil
}
...
func (aq *AchievementQuery) Modify(modifiers ...func(s *sql.Selector)) *AchievementSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (as *AchievementSelect) Modify(modifiers ...func(s *sql.Selector)) *AchievementSelect {
