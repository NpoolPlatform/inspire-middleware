...
func (opsc *OrderPaymentStatementCreate) Save(ctx context.Context) (*OrderPaymentStatement, error) {
	...
	if len(opsc.hooks) == 0 {
		...
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			opsc.mutation = mutation
			if node, err = opsc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
		...
		for i := len(opsc.hooks) - 1; i >= 0; i-- {
			if opsc.hooks[i] == nil {
				return nil, fmt.Errorf("ent: uninitialized hook (forgotten import ent/runtime?)")
			}
			mut = opsc.hooks[i](mut)
		}
		v, err := mut.Mutate(ctx, opsc.mutation)
		if err != nil {
			return nil, err
		}
...
func (opsc *OrderPaymentStatementCreate) defaults() error {
	if _, ok := opsc.mutation.CreatedAt(); !ok {
		if orderpaymentstatement.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized orderpaymentstatement.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := orderpaymentstatement.DefaultCreatedAt()
		opsc.mutation.SetCreatedAt(v)
	}
	if _, ok := opsc.mutation.UpdatedAt(); !ok {
		if orderpaymentstatement.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized orderpaymentstatement.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := orderpaymentstatement.DefaultUpdatedAt()
		opsc.mutation.SetUpdatedAt(v)
	}
	if _, ok := opsc.mutation.DeletedAt(); !ok {
		if orderpaymentstatement.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized orderpaymentstatement.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := orderpaymentstatement.DefaultDeletedAt()
		opsc.mutation.SetDeletedAt(v)
	}
	if _, ok := opsc.mutation.EntID(); !ok {
		if orderpaymentstatement.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized orderpaymentstatement.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := orderpaymentstatement.DefaultEntID()
		opsc.mutation.SetEntID(v)
	}
	if _, ok := opsc.mutation.StatementID(); !ok {
		if orderpaymentstatement.DefaultStatementID == nil {
			return fmt.Errorf("ent: uninitialized orderpaymentstatement.DefaultStatementID (forgotten import ent/runtime?)")
		}
		v := orderpaymentstatement.DefaultStatementID()
		opsc.mutation.SetStatementID(v)
	}
	if _, ok := opsc.mutation.PaymentCoinTypeID(); !ok {
		if orderpaymentstatement.DefaultPaymentCoinTypeID == nil {
			return fmt.Errorf("ent: uninitialized orderpaymentstatement.DefaultPaymentCoinTypeID (forgotten import ent/runtime?)")
		}
...
func (opsc *OrderPaymentStatementCreate) check() error {
	if _, ok := opsc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "OrderPaymentStatement.created_at"`)}
	}
	if _, ok := opsc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "OrderPaymentStatement.updated_at"`)}
	}
	if _, ok := opsc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "OrderPaymentStatement.deleted_at"`)}
	}
	if _, ok := opsc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "OrderPaymentStatement.ent_id"`)}
	}
	return nil
}
...
func (u *OrderPaymentStatementUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for OrderPaymentStatementCreate.OnConflict")
	}
...
func (u *OrderPaymentStatementUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the OrderPaymentStatementCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for OrderPaymentStatementCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
