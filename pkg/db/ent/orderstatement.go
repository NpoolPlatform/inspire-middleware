...
func (*OrderStatement) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case orderstatement.FieldEntID, orderstatement.FieldAppID, orderstatement.FieldUserID, orderstatement.FieldGoodID, orderstatement.FieldAppGoodID, orderstatement.FieldOrderID, orderstatement.FieldOrderUserID, orderstatement.FieldGoodCoinTypeID, orderstatement.FieldAppConfigID, orderstatement.FieldCommissionConfigID:
			values[i] = new(uuid.UUID)
		default:
			return nil, fmt.Errorf("unexpected column %q for type OrderStatement", columns[i])
		}
	}
	return values, nil
}
...
func (os *OrderStatement) assignValues(columns []string, values []interface{}) error {
...
func (os *OrderStatement) Update() *OrderStatementUpdateOne {
	return (&OrderStatementClient{config: os.config}).UpdateOne(os)
}
...
func (os *OrderStatement) Unwrap() *OrderStatement {
	...
	if !ok {
		panic("ent: OrderStatement is not a transactional entity")
	}
...
func (os OrderStatements) config(cfg config) {
	for _i := range os {
		os[_i].config = cfg
	}
}
