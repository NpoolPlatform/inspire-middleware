...
func (osc *OrderStatementCreate) defaults() error {
	if _, ok := osc.mutation.CreatedAt(); !ok {
		if orderstatement.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized orderstatement.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := orderstatement.DefaultCreatedAt()
		osc.mutation.SetCreatedAt(v)
	}
	if _, ok := osc.mutation.UpdatedAt(); !ok {
		if orderstatement.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized orderstatement.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := orderstatement.DefaultUpdatedAt()
		osc.mutation.SetUpdatedAt(v)
	}
	if _, ok := osc.mutation.DeletedAt(); !ok {
		if orderstatement.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized orderstatement.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := orderstatement.DefaultDeletedAt()
		osc.mutation.SetDeletedAt(v)
	}
	if _, ok := osc.mutation.EntID(); !ok {
		if orderstatement.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized orderstatement.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := orderstatement.DefaultEntID()
		osc.mutation.SetEntID(v)
	}
	if _, ok := osc.mutation.AppID(); !ok {
		if orderstatement.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized orderstatement.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := orderstatement.DefaultAppID()
		osc.mutation.SetAppID(v)
	}
	if _, ok := osc.mutation.UserID(); !ok {
		if orderstatement.DefaultUserID == nil {
			return fmt.Errorf("ent: uninitialized orderstatement.DefaultUserID (forgotten import ent/runtime?)")
		}
		v := orderstatement.DefaultUserID()
		osc.mutation.SetUserID(v)
	}
	if _, ok := osc.mutation.GoodID(); !ok {
		if orderstatement.DefaultGoodID == nil {
			return fmt.Errorf("ent: uninitialized orderstatement.DefaultGoodID (forgotten import ent/runtime?)")
		}
		v := orderstatement.DefaultGoodID()
		osc.mutation.SetGoodID(v)
	}
	if _, ok := osc.mutation.AppGoodID(); !ok {
		if orderstatement.DefaultAppGoodID == nil {
			return fmt.Errorf("ent: uninitialized orderstatement.DefaultAppGoodID (forgotten import ent/runtime?)")
		}
		v := orderstatement.DefaultAppGoodID()
		osc.mutation.SetAppGoodID(v)
	}
	if _, ok := osc.mutation.OrderID(); !ok {
		if orderstatement.DefaultOrderID == nil {
			return fmt.Errorf("ent: uninitialized orderstatement.DefaultOrderID (forgotten import ent/runtime?)")
		}
	...
	if _, ok := osc.mutation.AppConfigID(); !ok {
		if orderstatement.DefaultAppConfigID == nil {
			return fmt.Errorf("ent: uninitialized orderstatement.DefaultAppConfigID (forgotten import ent/runtime?)")
		}
		v := orderstatement.DefaultAppConfigID()
		osc.mutation.SetAppConfigID(v)
	}
	if _, ok := osc.mutation.CommissionConfigID(); !ok {
		if orderstatement.DefaultCommissionConfigID == nil {
			return fmt.Errorf("ent: uninitialized orderstatement.DefaultCommissionConfigID (forgotten import ent/runtime?)")
		}
...
func (osc *OrderStatementCreate) check() error {
	if _, ok := osc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "OrderStatement.created_at"`)}
	}
	if _, ok := osc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "OrderStatement.updated_at"`)}
	}
	if _, ok := osc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "OrderStatement.deleted_at"`)}
	}
	if _, ok := osc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "OrderStatement.ent_id"`)}
	}
	return nil
}
...
func (u *OrderStatementUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for OrderStatementCreate.OnConflict")
	}
...
func (u *OrderStatementUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the OrderStatementCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for OrderStatementCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
