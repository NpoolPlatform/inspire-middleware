...
func (gcac *GoodCoinAchievementCreate) Save(ctx context.Context) (*GoodCoinAchievement, error) {
	...
	if len(gcac.hooks) == 0 {
		...
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			gcac.mutation = mutation
			if node, err = gcac.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
		...
		for i := len(gcac.hooks) - 1; i >= 0; i-- {
			if gcac.hooks[i] == nil {
				return nil, fmt.Errorf("ent: uninitialized hook (forgotten import ent/runtime?)")
			}
			mut = gcac.hooks[i](mut)
		}
		v, err := mut.Mutate(ctx, gcac.mutation)
		if err != nil {
			return nil, err
		}
...
func (gcac *GoodCoinAchievementCreate) defaults() error {
	if _, ok := gcac.mutation.CreatedAt(); !ok {
		if goodcoinachievement.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized goodcoinachievement.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := goodcoinachievement.DefaultCreatedAt()
		gcac.mutation.SetCreatedAt(v)
	}
	if _, ok := gcac.mutation.UpdatedAt(); !ok {
		if goodcoinachievement.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized goodcoinachievement.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := goodcoinachievement.DefaultUpdatedAt()
		gcac.mutation.SetUpdatedAt(v)
	}
	if _, ok := gcac.mutation.DeletedAt(); !ok {
		if goodcoinachievement.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized goodcoinachievement.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := goodcoinachievement.DefaultDeletedAt()
		gcac.mutation.SetDeletedAt(v)
	}
	if _, ok := gcac.mutation.EntID(); !ok {
		if goodcoinachievement.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized goodcoinachievement.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := goodcoinachievement.DefaultEntID()
		gcac.mutation.SetEntID(v)
	}
	if _, ok := gcac.mutation.AppID(); !ok {
		if goodcoinachievement.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized goodcoinachievement.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := goodcoinachievement.DefaultAppID()
		gcac.mutation.SetAppID(v)
	}
	if _, ok := gcac.mutation.UserID(); !ok {
		if goodcoinachievement.DefaultUserID == nil {
			return fmt.Errorf("ent: uninitialized goodcoinachievement.DefaultUserID (forgotten import ent/runtime?)")
		}
		v := goodcoinachievement.DefaultUserID()
		gcac.mutation.SetUserID(v)
	}
	if _, ok := gcac.mutation.GoodCoinTypeID(); !ok {
		if goodcoinachievement.DefaultGoodCoinTypeID == nil {
			return fmt.Errorf("ent: uninitialized goodcoinachievement.DefaultGoodCoinTypeID (forgotten import ent/runtime?)")
		}
...
func (gcac *GoodCoinAchievementCreate) check() error {
	if _, ok := gcac.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "GoodCoinAchievement.created_at"`)}
	}
	if _, ok := gcac.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "GoodCoinAchievement.updated_at"`)}
	}
	if _, ok := gcac.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "GoodCoinAchievement.deleted_at"`)}
	}
	if _, ok := gcac.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "GoodCoinAchievement.ent_id"`)}
	}
	return nil
}
...
func (u *GoodCoinAchievementUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for GoodCoinAchievementCreate.OnConflict")
	}
...
func (u *GoodCoinAchievementUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the GoodCoinAchievementCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for GoodCoinAchievementCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
