...
var (
	...
	CommissionsColumns = []*schema.Column{
		...
		{Name: "start_at", Type: field.TypeUint32, Nullable: true, Default: 1691414602},
		{Name: "end_at", Type: field.TypeUint32, Nullable: true, Default: 0},
		{Name: "settle_type", Type: field.TypeString, Nullable: true, Default: "NoCommission"},
		...
		{Name: "settle_amount", Type: field.TypeString, Nullable: true, Default: "SettleByPercent"},
