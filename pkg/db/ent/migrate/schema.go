...
var (
	...
	CashControlsColumns = []*schema.Column{
		...
		{Name: "app_id", Type: field.TypeUUID, Nullable: true},
		{Name: "coupon_id", Type: field.TypeUUID, Nullable: true},
		{Name: "control_type", Type: field.TypeString, Nullable: true, Default: "DefaultCashControlType"},
	...
	CommissionsColumns = []*schema.Column{
		...
		{Name: "start_at", Type: field.TypeUint32, Nullable: true, Default: 1704254175},
