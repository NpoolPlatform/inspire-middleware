...
func (sq *StatementQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (sq *StatementQuery) FirstIDX(ctx context.Context) uint32 {
...
func (sq *StatementQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (sq *StatementQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (sq *StatementQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (sq *StatementQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *StatementQuery) prepareQuery(ctx context.Context) error {
	...
	if statement.Policy == nil {
		return errors.New("ent: uninitialized statement.Policy (forgotten import ent/runtime?)")
	}
	if err := statement.Policy.EvalQuery(ctx, sq); err != nil {
		return err
	}
	return nil
}
...
func (sq *StatementQuery) ForUpdate(opts ...sql.LockOption) *StatementQuery {
...
func (sq *StatementQuery) ForShare(opts ...sql.LockOption) *StatementQuery {
	if sq.driver.Dialect() == dialect.Postgres {
		sq.Unique(false)
	}
	sq.modifiers = append(sq.modifiers, func(s *sql.Selector) {
