...
func (tcc *TaskConfigCreate) defaults() error {
	if _, ok := tcc.mutation.CreatedAt(); !ok {
		if taskconfig.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized taskconfig.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := taskconfig.DefaultCreatedAt()
		tcc.mutation.SetCreatedAt(v)
	}
	if _, ok := tcc.mutation.UpdatedAt(); !ok {
		if taskconfig.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized taskconfig.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := taskconfig.DefaultUpdatedAt()
		tcc.mutation.SetUpdatedAt(v)
	}
	if _, ok := tcc.mutation.DeletedAt(); !ok {
		if taskconfig.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized taskconfig.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := taskconfig.DefaultDeletedAt()
		tcc.mutation.SetDeletedAt(v)
	}
	if _, ok := tcc.mutation.EntID(); !ok {
		if taskconfig.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized taskconfig.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := taskconfig.DefaultEntID()
		tcc.mutation.SetEntID(v)
	}
	if _, ok := tcc.mutation.AppID(); !ok {
		if taskconfig.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized taskconfig.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := taskconfig.DefaultAppID()
		tcc.mutation.SetAppID(v)
	}
	if _, ok := tcc.mutation.EventID(); !ok {
		if taskconfig.DefaultEventID == nil {
			return fmt.Errorf("ent: uninitialized taskconfig.DefaultEventID (forgotten import ent/runtime?)")
		}
	...
	if _, ok := tcc.mutation.LastTaskID(); !ok {
		if taskconfig.DefaultLastTaskID == nil {
			return fmt.Errorf("ent: uninitialized taskconfig.DefaultLastTaskID (forgotten import ent/runtime?)")
		}
...
func (tcc *TaskConfigCreate) check() error {
	if _, ok := tcc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "TaskConfig.created_at"`)}
	}
	if _, ok := tcc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "TaskConfig.updated_at"`)}
	}
	if _, ok := tcc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "TaskConfig.deleted_at"`)}
	}
	if _, ok := tcc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "TaskConfig.ent_id"`)}
	}
	return nil
}
...
func (u *TaskConfigUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for TaskConfigCreate.OnConflict")
	}
...
func (u *TaskConfigUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the TaskConfigCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for TaskConfigCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
