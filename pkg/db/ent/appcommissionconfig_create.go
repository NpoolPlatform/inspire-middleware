...
func (accc *AppCommissionConfigCreate) Save(ctx context.Context) (*AppCommissionConfig, error) {
	...
	if len(accc.hooks) == 0 {
		...
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			accc.mutation = mutation
			if node, err = accc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
		...
		for i := len(accc.hooks) - 1; i >= 0; i-- {
			if accc.hooks[i] == nil {
				return nil, fmt.Errorf("ent: uninitialized hook (forgotten import ent/runtime?)")
			}
			mut = accc.hooks[i](mut)
		}
		v, err := mut.Mutate(ctx, accc.mutation)
		if err != nil {
			return nil, err
		}
...
func (accc *AppCommissionConfigCreate) defaults() error {
	if _, ok := accc.mutation.CreatedAt(); !ok {
		if appcommissionconfig.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized appcommissionconfig.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := appcommissionconfig.DefaultCreatedAt()
		accc.mutation.SetCreatedAt(v)
	}
	if _, ok := accc.mutation.UpdatedAt(); !ok {
		if appcommissionconfig.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized appcommissionconfig.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := appcommissionconfig.DefaultUpdatedAt()
		accc.mutation.SetUpdatedAt(v)
	}
	if _, ok := accc.mutation.DeletedAt(); !ok {
		if appcommissionconfig.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized appcommissionconfig.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := appcommissionconfig.DefaultDeletedAt()
		accc.mutation.SetDeletedAt(v)
	}
	if _, ok := accc.mutation.EntID(); !ok {
		if appcommissionconfig.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized appcommissionconfig.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := appcommissionconfig.DefaultEntID()
		accc.mutation.SetEntID(v)
	}
	if _, ok := accc.mutation.AppID(); !ok {
		if appcommissionconfig.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized appcommissionconfig.DefaultAppID (forgotten import ent/runtime?)")
		}
...
func (accc *AppCommissionConfigCreate) check() error {
	if _, ok := accc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "AppCommissionConfig.created_at"`)}
	}
	if _, ok := accc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "AppCommissionConfig.updated_at"`)}
	}
	if _, ok := accc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "AppCommissionConfig.deleted_at"`)}
	}
	if _, ok := accc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "AppCommissionConfig.ent_id"`)}
	}
	return nil
}
...
func (u *AppCommissionConfigUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppCommissionConfigCreate.OnConflict")
	}
...
func (u *AppCommissionConfigUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the AppCommissionConfigCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppCommissionConfigCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
