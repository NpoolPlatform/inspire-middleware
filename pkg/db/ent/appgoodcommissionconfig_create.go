...
func (agccc *AppGoodCommissionConfigCreate) Save(ctx context.Context) (*AppGoodCommissionConfig, error) {
	...
	if err := agccc.defaults(); err != nil {
		return nil, err
	}
	if len(agccc.hooks) == 0 {
		if err = agccc.check(); err != nil {
			return nil, err
		}
		node, err = agccc.sqlSave(ctx)
	} else {
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			agccc.mutation = mutation
			if node, err = agccc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
		...
		for i := len(agccc.hooks) - 1; i >= 0; i-- {
			if agccc.hooks[i] == nil {
				return nil, fmt.Errorf("ent: uninitialized hook (forgotten import ent/runtime?)")
			}
			mut = agccc.hooks[i](mut)
		}
		v, err := mut.Mutate(ctx, agccc.mutation)
		if err != nil {
			return nil, err
		}
...
func (agccc *AppGoodCommissionConfigCreate) defaults() error {
	if _, ok := agccc.mutation.CreatedAt(); !ok {
		if appgoodcommissionconfig.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized appgoodcommissionconfig.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := appgoodcommissionconfig.DefaultCreatedAt()
		agccc.mutation.SetCreatedAt(v)
	}
	if _, ok := agccc.mutation.UpdatedAt(); !ok {
		if appgoodcommissionconfig.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized appgoodcommissionconfig.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := appgoodcommissionconfig.DefaultUpdatedAt()
		agccc.mutation.SetUpdatedAt(v)
	}
	if _, ok := agccc.mutation.DeletedAt(); !ok {
		if appgoodcommissionconfig.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized appgoodcommissionconfig.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := appgoodcommissionconfig.DefaultDeletedAt()
		agccc.mutation.SetDeletedAt(v)
	}
	if _, ok := agccc.mutation.EntID(); !ok {
		if appgoodcommissionconfig.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized appgoodcommissionconfig.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := appgoodcommissionconfig.DefaultEntID()
		agccc.mutation.SetEntID(v)
	}
	if _, ok := agccc.mutation.AppID(); !ok {
		if appgoodcommissionconfig.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized appgoodcommissionconfig.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := appgoodcommissionconfig.DefaultAppID()
		agccc.mutation.SetAppID(v)
	}
	if _, ok := agccc.mutation.GoodID(); !ok {
		if appgoodcommissionconfig.DefaultGoodID == nil {
			return fmt.Errorf("ent: uninitialized appgoodcommissionconfig.DefaultGoodID (forgotten import ent/runtime?)")
		}
		v := appgoodcommissionconfig.DefaultGoodID()
		agccc.mutation.SetGoodID(v)
	}
	if _, ok := agccc.mutation.AppGoodID(); !ok {
		if appgoodcommissionconfig.DefaultAppGoodID == nil {
			return fmt.Errorf("ent: uninitialized appgoodcommissionconfig.DefaultAppGoodID (forgotten import ent/runtime?)")
		}
...
func (agccc *AppGoodCommissionConfigCreate) check() error {
	if _, ok := agccc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "AppGoodCommissionConfig.created_at"`)}
	}
	if _, ok := agccc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "AppGoodCommissionConfig.updated_at"`)}
	}
	if _, ok := agccc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "AppGoodCommissionConfig.deleted_at"`)}
	}
	if _, ok := agccc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "AppGoodCommissionConfig.ent_id"`)}
	}
	return nil
}
...
func (u *AppGoodCommissionConfigUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppGoodCommissionConfigCreate.OnConflict")
	}
...
func (u *AppGoodCommissionConfigUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the AppGoodCommissionConfigCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppGoodCommissionConfigCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
