...
// SetAppID sets the "app_id" field.
func (m *CouponScopeMutation) SetAppID(u uuid.UUID) {
	m.app_id = &u
}

// AppID returns the value of the "app_id" field in the mutation.
func (m *CouponScopeMutation) AppID() (r uuid.UUID, exists bool) {
	v := m.app_id
	if v == nil {
		return
	}
...
// OldAppID returns the old "app_id" field's value of the CouponScope entity.
// If the CouponScope object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CouponScopeMutation) OldAppID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAppID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetAppID resets all changes to the "app_id" field.
func (m *CouponScopeMutation) ResetAppID() {
	m.app_id = nil
}
...
// SetAppGoodID sets the "app_good_id" field.
func (m *CouponScopeMutation) SetAppGoodID(u uuid.UUID) {
	m.app_good_id = &u
}

// AppGoodID returns the value of the "app_good_id" field in the mutation.
func (m *CouponScopeMutation) AppGoodID() (r uuid.UUID, exists bool) {
	v := m.app_good_id
	if v == nil {
		return
	}
...
// OldAppGoodID returns the old "app_good_id" field's value of the CouponScope entity.
// If the CouponScope object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CouponScopeMutation) OldAppGoodID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAppGoodID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearAppGoodID clears the value of the "app_good_id" field.
func (m *CouponScopeMutation) ClearAppGoodID() {
	m.app_good_id = nil
	m.clearedFields[couponscope.FieldAppGoodID] = struct{}{}
}

// AppGoodIDCleared returns if the "app_good_id" field was cleared in this mutation.
func (m *CouponScopeMutation) AppGoodIDCleared() bool {
	_, ok := m.clearedFields[couponscope.FieldAppGoodID]
	return ok
}

// ResetAppGoodID resets all changes to the "app_good_id" field.
func (m *CouponScopeMutation) ResetAppGoodID() {
	m.app_good_id = nil
	delete(m.clearedFields, couponscope.FieldAppGoodID)
}
...
func (m *CouponScopeMutation) Fields() []string {
	...
	if m.app_id != nil {
		fields = append(fields, couponscope.FieldAppID)
	}
	if m.coupon_id != nil {
		fields = append(fields, couponscope.FieldCouponID)
	}
	if m.app_good_id != nil {
		fields = append(fields, couponscope.FieldAppGoodID)
	}
	if m.coupon_scope != nil {
...
func (m *CouponScopeMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(couponscope.FieldAppGoodID) {
		fields = append(fields, couponscope.FieldAppGoodID)
	}
