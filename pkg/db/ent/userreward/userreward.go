...
const (
	// Label holds the string label denoting the userreward type in the database.
	Label = "user_reward"
	...
	FieldCouponCashableAmount = "coupon_cashable_amount"
	// Table holds the table name of the userreward in the database.
	Table = "user_rewards"
)

// Columns holds all SQL columns for userreward fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
var (
	...
	DefaultCouponCashableAmount decimal.Decimal
)
