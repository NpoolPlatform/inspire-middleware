...
func (ac *AchievementCreate) defaults() error {
	if _, ok := ac.mutation.CreatedAt(); !ok {
		if achievement.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized achievement.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := achievement.DefaultCreatedAt()
		ac.mutation.SetCreatedAt(v)
	}
	if _, ok := ac.mutation.UpdatedAt(); !ok {
		if achievement.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized achievement.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := achievement.DefaultUpdatedAt()
		ac.mutation.SetUpdatedAt(v)
	}
	if _, ok := ac.mutation.DeletedAt(); !ok {
		if achievement.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized achievement.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
	...
	if _, ok := ac.mutation.UserID(); !ok {
		if achievement.DefaultUserID == nil {
			return fmt.Errorf("ent: uninitialized achievement.DefaultUserID (forgotten import ent/runtime?)")
		}
		v := achievement.DefaultUserID()
		ac.mutation.SetUserID(v)
	}
	if _, ok := ac.mutation.GoodID(); !ok {
		if achievement.DefaultGoodID == nil {
			return fmt.Errorf("ent: uninitialized achievement.DefaultGoodID (forgotten import ent/runtime?)")
		}
