...
func (ccc *CashControlCreate) defaults() error {
	if _, ok := ccc.mutation.CreatedAt(); !ok {
		if cashcontrol.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized cashcontrol.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := cashcontrol.DefaultCreatedAt()
		ccc.mutation.SetCreatedAt(v)
	}
	if _, ok := ccc.mutation.UpdatedAt(); !ok {
		if cashcontrol.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized cashcontrol.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := cashcontrol.DefaultUpdatedAt()
		ccc.mutation.SetUpdatedAt(v)
	}
	if _, ok := ccc.mutation.DeletedAt(); !ok {
		if cashcontrol.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized cashcontrol.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := cashcontrol.DefaultDeletedAt()
		ccc.mutation.SetDeletedAt(v)
	}
	if _, ok := ccc.mutation.EntID(); !ok {
		if cashcontrol.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized cashcontrol.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := cashcontrol.DefaultEntID()
		ccc.mutation.SetEntID(v)
	}
	if _, ok := ccc.mutation.AppID(); !ok {
		if cashcontrol.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized cashcontrol.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := cashcontrol.DefaultAppID()
		ccc.mutation.SetAppID(v)
	}
	if _, ok := ccc.mutation.CouponID(); !ok {
		if cashcontrol.DefaultCouponID == nil {
			return fmt.Errorf("ent: uninitialized cashcontrol.DefaultCouponID (forgotten import ent/runtime?)")
		}
...
func (ccc *CashControlCreate) check() error {
	if _, ok := ccc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "CashControl.created_at"`)}
	}
	if _, ok := ccc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "CashControl.updated_at"`)}
	}
	if _, ok := ccc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "CashControl.deleted_at"`)}
	}
	if _, ok := ccc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "CashControl.ent_id"`)}
	}
	return nil
}
...
func (u *CashControlUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for CashControlCreate.OnConflict")
	}
...
func (u *CashControlUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the CashControlCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for CashControlCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
