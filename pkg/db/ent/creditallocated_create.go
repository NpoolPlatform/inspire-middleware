...
func (cac *CreditAllocatedCreate) defaults() error {
	if _, ok := cac.mutation.CreatedAt(); !ok {
		if creditallocated.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized creditallocated.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := creditallocated.DefaultCreatedAt()
		cac.mutation.SetCreatedAt(v)
	}
	if _, ok := cac.mutation.UpdatedAt(); !ok {
		if creditallocated.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized creditallocated.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := creditallocated.DefaultUpdatedAt()
		cac.mutation.SetUpdatedAt(v)
	}
	if _, ok := cac.mutation.DeletedAt(); !ok {
		if creditallocated.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized creditallocated.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := creditallocated.DefaultDeletedAt()
		cac.mutation.SetDeletedAt(v)
	}
	if _, ok := cac.mutation.EntID(); !ok {
		if creditallocated.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized creditallocated.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := creditallocated.DefaultEntID()
		cac.mutation.SetEntID(v)
	}
	if _, ok := cac.mutation.AppID(); !ok {
		if creditallocated.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized creditallocated.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := creditallocated.DefaultAppID()
		cac.mutation.SetAppID(v)
	}
	if _, ok := cac.mutation.UserID(); !ok {
		if creditallocated.DefaultUserID == nil {
			return fmt.Errorf("ent: uninitialized creditallocated.DefaultUserID (forgotten import ent/runtime?)")
		}
...
func (cac *CreditAllocatedCreate) check() error {
	if _, ok := cac.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "CreditAllocated.created_at"`)}
	}
	if _, ok := cac.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "CreditAllocated.updated_at"`)}
	}
	if _, ok := cac.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "CreditAllocated.deleted_at"`)}
	}
	if _, ok := cac.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "CreditAllocated.ent_id"`)}
	}
...
func (u *CreditAllocatedUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for CreditAllocatedCreate.OnConflict")
	}
...
func (u *CreditAllocatedUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the CreditAllocatedCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for CreditAllocatedCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
