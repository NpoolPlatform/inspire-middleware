...
func (ecc *EventCouponCreate) defaults() error {
	if _, ok := ecc.mutation.CreatedAt(); !ok {
		if eventcoupon.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized eventcoupon.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := eventcoupon.DefaultCreatedAt()
		ecc.mutation.SetCreatedAt(v)
	}
	if _, ok := ecc.mutation.UpdatedAt(); !ok {
		if eventcoupon.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized eventcoupon.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := eventcoupon.DefaultUpdatedAt()
		ecc.mutation.SetUpdatedAt(v)
	}
	if _, ok := ecc.mutation.DeletedAt(); !ok {
		if eventcoupon.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized eventcoupon.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := eventcoupon.DefaultDeletedAt()
		ecc.mutation.SetDeletedAt(v)
	}
	if _, ok := ecc.mutation.EntID(); !ok {
		if eventcoupon.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized eventcoupon.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := eventcoupon.DefaultEntID()
		ecc.mutation.SetEntID(v)
	}
	if _, ok := ecc.mutation.AppID(); !ok {
		if eventcoupon.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized eventcoupon.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := eventcoupon.DefaultAppID()
		ecc.mutation.SetAppID(v)
	}
	if _, ok := ecc.mutation.EventID(); !ok {
		if eventcoupon.DefaultEventID == nil {
			return fmt.Errorf("ent: uninitialized eventcoupon.DefaultEventID (forgotten import ent/runtime?)")
		}
		v := eventcoupon.DefaultEventID()
		ecc.mutation.SetEventID(v)
	}
	if _, ok := ecc.mutation.CouponID(); !ok {
		if eventcoupon.DefaultCouponID == nil {
			return fmt.Errorf("ent: uninitialized eventcoupon.DefaultCouponID (forgotten import ent/runtime?)")
		}
...
func (ecc *EventCouponCreate) check() error {
	if _, ok := ecc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "EventCoupon.created_at"`)}
	}
	if _, ok := ecc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "EventCoupon.updated_at"`)}
	}
	if _, ok := ecc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "EventCoupon.deleted_at"`)}
	}
	if _, ok := ecc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "EventCoupon.ent_id"`)}
	}
	return nil
}
