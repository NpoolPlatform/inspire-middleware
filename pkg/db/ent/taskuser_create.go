...
func (tuc *TaskUserCreate) defaults() error {
	if _, ok := tuc.mutation.CreatedAt(); !ok {
		if taskuser.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized taskuser.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := taskuser.DefaultCreatedAt()
		tuc.mutation.SetCreatedAt(v)
	}
	if _, ok := tuc.mutation.UpdatedAt(); !ok {
		if taskuser.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized taskuser.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := taskuser.DefaultUpdatedAt()
		tuc.mutation.SetUpdatedAt(v)
	}
	if _, ok := tuc.mutation.DeletedAt(); !ok {
		if taskuser.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized taskuser.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := taskuser.DefaultDeletedAt()
		tuc.mutation.SetDeletedAt(v)
	}
	if _, ok := tuc.mutation.EntID(); !ok {
		if taskuser.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized taskuser.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := taskuser.DefaultEntID()
		tuc.mutation.SetEntID(v)
	}
	if _, ok := tuc.mutation.AppID(); !ok {
		if taskuser.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized taskuser.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := taskuser.DefaultAppID()
		tuc.mutation.SetAppID(v)
	}
	if _, ok := tuc.mutation.UserID(); !ok {
		if taskuser.DefaultUserID == nil {
			return fmt.Errorf("ent: uninitialized taskuser.DefaultUserID (forgotten import ent/runtime?)")
		}
		v := taskuser.DefaultUserID()
		tuc.mutation.SetUserID(v)
	}
	if _, ok := tuc.mutation.TaskID(); !ok {
		if taskuser.DefaultTaskID == nil {
			return fmt.Errorf("ent: uninitialized taskuser.DefaultTaskID (forgotten import ent/runtime?)")
		}
		v := taskuser.DefaultTaskID()
		tuc.mutation.SetTaskID(v)
	}
	if _, ok := tuc.mutation.EventID(); !ok {
		if taskuser.DefaultEventID == nil {
			return fmt.Errorf("ent: uninitialized taskuser.DefaultEventID (forgotten import ent/runtime?)")
		}
...
func (tuc *TaskUserCreate) check() error {
	if _, ok := tuc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "TaskUser.created_at"`)}
	}
	if _, ok := tuc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "TaskUser.updated_at"`)}
	}
	if _, ok := tuc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "TaskUser.deleted_at"`)}
	}
	if _, ok := tuc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "TaskUser.ent_id"`)}
	}
	return nil
}
...
func (u *TaskUserUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for TaskUserCreate.OnConflict")
	}
...
func (u *TaskUserUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the TaskUserCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for TaskUserCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
