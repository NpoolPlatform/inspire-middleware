...
func (sc *StatementCreate) defaults() error {
	...
	if _, ok := sc.mutation.EntID(); !ok {
		if statement.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized statement.DefaultEntID (forgotten import ent/runtime?)")
		}
	...
	if _, ok := sc.mutation.DirectContributorID(); !ok {
		if statement.DefaultDirectContributorID == nil {
			return fmt.Errorf("ent: uninitialized statement.DefaultDirectContributorID (forgotten import ent/runtime?)")
		}
		v := statement.DefaultDirectContributorID()
		sc.mutation.SetDirectContributorID(v)
	}
	if _, ok := sc.mutation.GoodID(); !ok {
		if statement.DefaultGoodID == nil {
			return fmt.Errorf("ent: uninitialized statement.DefaultGoodID (forgotten import ent/runtime?)")
		}
	...
	if _, ok := sc.mutation.PaymentID(); !ok {
		if statement.DefaultPaymentID == nil {
			return fmt.Errorf("ent: uninitialized statement.DefaultPaymentID (forgotten import ent/runtime?)")
		}
	...
	if _, ok := sc.mutation.PaymentCoinTypeID(); !ok {
		if statement.DefaultPaymentCoinTypeID == nil {
			return fmt.Errorf("ent: uninitialized statement.DefaultPaymentCoinTypeID (forgotten import ent/runtime?)")
		}
...
func (sc *StatementCreate) check() error {
	...
	if _, ok := sc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "Statement.ent_id"`)}
	}
	return nil
}
...
func (sc *StatementCreate) createSpec() (*Statement, *sqlgraph.CreateSpec) {
	...
	if value, ok := sc.mutation.DirectContributorID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: statement.FieldDirectContributorID,
		})
	...
	if value, ok := sc.mutation.SelfOrder(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeBool,
			Value:  value,
			Column: statement.FieldSelfOrder,
		})
	...
	if value, ok := sc.mutation.PaymentID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: statement.FieldPaymentID,
		})
	...
	if value, ok := sc.mutation.PaymentCoinTypeID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: statement.FieldPaymentCoinTypeID,
		})
	...
	if value, ok := sc.mutation.PaymentCoinUsdCurrency(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			...
			Value:  value,
			Column: statement.FieldPaymentCoinUsdCurrency,
		})
	...
	if value, ok := sc.mutation.UsdAmount(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeOther,
			Value:  value,
			Column: statement.FieldUsdAmount,
		})
