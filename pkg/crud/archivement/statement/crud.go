...
func CreateSet(c *ent.ArchivementDetailCreate, req *Req) *ent.ArchivementDetailCreate { //nolint
	if req.ID != nil {
		c.SetID(*req.ID)
	}
	if req.AppID != nil {
...
func SetQueryConds(q *ent.ArchivementDetailQuery, conds *Conds) (*ent.ArchivementDetailQuery, error) { //nolint
	q.Where(entarchivementdetail.DeletedAt(0))
	if conds == nil {
		return q, nil
	}
	if conds.ID != nil {
