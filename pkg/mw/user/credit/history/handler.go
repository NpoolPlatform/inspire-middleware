...
import (
	...
	usercredithistorycrud "github.com/NpoolPlatform/inspire-middleware/pkg/crud/user/credit/history"
...
type Handler struct {
	usercredithistorycrud.Req
	Conds  *usercredithistorycrud.Conds
	Offset int32
	Limit  int32
}
...
func WithConds(conds *npool.Conds) func(context.Context, *Handler) error {
	return func(ctx context.Context, h *Handler) error {
		h.Conds = &usercredithistorycrud.Conds{}
		if conds == nil {
			return nil
		}
		if conds.EntID != nil {
