...
func (h *queryHandler) queryAchivement(cli *ent.Client) {
	h.selectAchivement(
		cli.Achivement.
			Query().
			Where(
				entachivement.ID(*h.ID),
...
func (h *Handler) GetAchivement(ctx context.Context) (*npool.Achivement, error) {
	if h.ID == nil {
