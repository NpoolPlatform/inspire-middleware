...
func (h *createHandler) cashable(ctx context.Context) bool {
	...
	value := rand.Float64()
	if decimal.NewFromFloat(value).Cmp(h.coupon.CashableProbabilityPerMillion) <= 0 {
		return true
	}
	return false
}
