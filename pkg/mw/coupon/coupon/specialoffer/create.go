...
func CreateSpecialOffer(ctx context.Context, in *npool.CouponReq) (*npool.Coupon, error) {
	info, err := specialoffermgrcli.CreateSpecialOffer(ctx, &specialoffermgrpb.SpecialOfferReq{
		ID:               in.ID,
		AppID:            in.AppID,
		UserID:           in.UserID,
		Amount:           in.Value,
