# Npool inspire gateway

[![Test](https://github.com/NpoolPlatform/inspire-gateway/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/inspire-gateway/actions/workflows/main.yml)
...
* make inspire-gateway ```单独编译服务```
* make inspire-gateway-image ```单独生成服务镜像```
