...
func (s *Server) CreateCommissionConfig(ctx context.Context, in *npool.CreateAppGoodCommissionConfigRequest) (*npool.CreateAppGoodCommissionConfigResponse, error) {
	req := in.GetInfo()
	if req == nil {
		logger.Sugar().Errorw(
